...
def disableButtons():
    buttonMJ["state"] = DISABLED
    buttonMJC["state"] = DISABLED
    buttonML["state"] = DISABLED
    buttonMC["state"] = DISABLED
    buttonDisp["state"] = DISABLED
    buttonReset["state"] = DISABLED

def enableButtons():
    buttonMJ["state"] = "normal"
    buttonMJC["state"] = "normal"
    buttonML["state"] = "normal"
    buttonMC["state"] = "normal"
    buttonDisp["state"] = "normal"
...
def moveJ():
    ...
    print(eJ1.get())
    print(eJ2.get())
    print(armSolution.get())
    print(toolPosition.get())
    time.sleep(1)
...
def resetPosition():
    ...
    global indexCMD
    indexCMD = 6
    #send reset position command to msp430
    time.sleep(1)
    enableButtons()
