 ...
 *  Modified: by Jamie Boyd/Matthew Wonneberg   - completed or added many functions
 **************************************************************************************************/
...
#define     RX_BUF_SZ       40                         // size for buffer to receive characters from terminal
...
typedef unsigned char (*rxIntFunc)(char);             // typedef for function reference for Rx interrupt
typedef char (*txIntFunc)(unsigned char*);            // typedef for function reference for Tx interrupt
...
* Author: Greg Scutt
* Date: March 1st, 2017
* Modified: 2022/01/10 by Jamie Boyd/Matthew Wonneberg for SCARA with baud set to 115200 */
